      ...
      >
        ...
        <div className={`h-32 bg-gradient-to-br ${gradientMap[gradient]} relative overflow-hidden`}>
          ...
          <div className="absolute inset-0 opacity-30">
            ...
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-24 h-24 border border-white/10 rounded-2xl rotate-45" />
          </div>
        ...
        <div className="p-6">
          ...
          <div className="flex flex-wrap gap-2 mb-4">
            ...
            {techStack.length > 5 && (
              <span className="px-2 py-1 text-xs bg-white/5 border border-white/10 rounded-full text-gray-400">
                +{techStack.length - 5}
              </span>
            )}
          </div>
            ...
            {liveLink && (
              <a
                ...
                className="
                  ...
                  hover:bg-blue-500/30 hover:text-blue-300 hover:border-blue-500/50
                  transition-all duration-200
                "
